  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(30, 136, 229, 1);fontSize:28px;">吕梁学院校友录网站小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="校友账号" class="input" v-if="tableName=='xiaoyou'">
			  <el-input v-model="ruleForm.xiaoyouzhanghao" autocomplete="off" placeholder="校友账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='xiaoyou'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="校友姓名" class="input" v-if="tableName=='xiaoyou'">
			  <el-input v-model="ruleForm.xiaoyouxingming" autocomplete="off" placeholder="校友姓名" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='xiaoyou'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
