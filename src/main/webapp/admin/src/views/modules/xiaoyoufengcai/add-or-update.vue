  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="联系方式" prop="lianxifangshi">
              <el-input v-model="ruleForm.lianxifangshi" 
                placeholder="联系方式" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="专业班级" prop="zhuanyebanji">
          <el-select v-model="ruleForm.zhuanyebanji" placeholder="请选择专业班级">
            <el-option
                v-for="(item,index) in zhuanyebanjiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="专业班级" prop="zhuanyebanji">
	      <el-input v-model="ruleForm.zhuanyebanji"
                placeholder="专业班级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                      </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.gerenjieshao = this.ruleForm.gerenjieshao.replace(reg,'../../../ssm5i1pf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
