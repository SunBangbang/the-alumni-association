          ...
          <el-form-item class="input" v-if="ruleForm.fabushijian" label="发布时间" prop="fabushijian">
              <el-input v-model="ruleForm.fabushijian" 
                placeholder="发布时间" readonly></el-input>
                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="视频简介" prop="shipinjianjie">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shipinjianjie" label="视频简介" prop="shipinjianjie">
                    <span v-html="ruleForm.shipinjianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shipinjianjie = this.ruleForm.shipinjianjie.replace(reg,'../../../ssm5i1pf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xiaoyoushipin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaoyoushipinCrossAddOrUpdateFlag = false;
                  this.parent.search();
